...
def crearVentana(titulo,dimension):
    ventana = Tk()
...
def agregarBarra(ventana, imagenes, textosTooltip=None):
    ...
    for imagen in imagenes:
        ...
        # Redimensionar la imagen a un tamaño más adecuado (por ejemplo, 50x50 píxeles)
        img_redimensionada = img_original.resize((50, 50), Image.LANCZOS)
        ...
        # Añadir tooltip si se proporcionó
        if textosTooltip:
